...
yum -y update && yum -y install wget && wget http://script.hostingtermurah.net/script-whitelabel/centos/centos7-kvm.sh && chmod +x centos7-kvm.sh && ./centos7-kvm.sh && rm -f centos7-kvm.sh && history -c
